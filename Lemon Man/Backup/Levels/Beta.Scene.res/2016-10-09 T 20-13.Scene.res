<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
                        ...
                        <_items dataType="Array" type="Duality.Component[]" id="585125222" length="4">
                          ...
                          <item dataType="Struct" type="Behavior.HeldWeapon" id="971760278">
                            ...
                            <heldWeapon dataType="Struct" type="Misc.Weapon" id="1572667994">
                              <_x003C_Accuracy_x003E_k__BackingField dataType="Int">5</_x003C_Accuracy_x003E_k__BackingField>
                              <_x003C_BurstCount_x003E_k__BackingField dataType="Int">6</_x003C_BurstCount_x003E_k__BackingField>
    ...
    <item dataType="Struct" type="Duality.GameObject" id="42419338">
      <active dataType="Bool">true</active>
      <children />
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3544896212">
        <_items dataType="Array" type="Duality.Component[]" id="3934801636">
          <item dataType="Struct" type="Duality.Components.Transform" id="2402734270">
            <active dataType="Bool">true</active>
            <angle dataType="Float">0</angle>
            <angleAbs dataType="Float">0</angleAbs>
            <angleVel dataType="Float">0</angleVel>
            <angleVelAbs dataType="Float">0</angleVelAbs>
            <deriveAngle dataType="Bool">true</deriveAngle>
            <gameobj dataType="ObjectRef">42419338</gameobj>
            <ignoreParent dataType="Bool">false</ignoreParent>
            <parentTransform />
            <pos dataType="Struct" type="Duality.Vector3" />
            <posAbs dataType="Struct" type="Duality.Vector3" />
          ...
          <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="1684585906">
            <active dataType="Bool">true</active>
            <colorTint dataType="Struct" type="Duality.Drawing.ColorRgba">
              <A dataType="Byte">255</A>
              <B dataType="Byte">255</B>
          ...
          <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="3105195862">
            <active dataType="Bool">true</active>
            <angularDamp dataType="Float">0.3</angularDamp>
            <angularVel dataType="Float">0</angularVel>
            ...
            <linearVel dataType="Struct" type="Duality.Vector2" />
            <revolutions dataType="Float">0</revolutions>
            <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="2319515150">
              <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="458321872">
                <item dataType="Struct" type="Duality.Components.Physics.PolyShapeInfo" id="499436220">
                  <density dataType="Float">1</density>
                  <friction dataType="Float">0.3</friction>
                  <parent dataType="ObjectRef">3105195862</parent>
                  <restitution dataType="Float">0.3</restitution>
                  <sensor dataType="Bool">true</sensor>
                  <vertices dataType="Array" type="Duality.Vector2[]" id="2000970308">
                    <item dataType="Struct" type="Duality.Vector2">
                      <X dataType="Float">-2</X>
                      <Y dataType="Float">-2</Y>
                    </item>
          ...
          <item dataType="Struct" type="Behavior.Bullet" id="713102608">
            <_x003C_BulletLifetime_x003E_k__BackingField dataType="Float">85</_x003C_BulletLifetime_x003E_k__BackingField>
            <_x003C_Creator_x003E_k__BackingField dataType="Struct" type="Duality.GameObject" id="441064268">
              <active dataType="Bool">true</active>
              <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="600913248">
                <_items dataType="Array" type="Duality.GameObject[]" id="610823388" length="4" />
                <_size dataType="Int">0</_size>
                <_version dataType="Int">2</_version>
              </children>
              <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2911843470">
                <_items dataType="Array" type="Duality.Component[]" id="3091326386" length="8">
                  <item dataType="Struct" type="Duality.Components.Transform" id="2558091680">
                    <active dataType="Bool">true</active>
                    <angle dataType="Float">0</angle>
                    <angleAbs dataType="Float">0</angleAbs>
                    <angleVel dataType="Float">0</angleVel>
                    <angleVelAbs dataType="Float">0</angleVelAbs>
                    <deriveAngle dataType="Bool">true</deriveAngle>
                    <gameobj dataType="ObjectRef">441064268</gameobj>
                    <ignoreParent dataType="Bool">false</ignoreParent>
                    <parentTransform />
                    <pos dataType="Struct" type="Duality.Vector3">
                      <X dataType="Float">0</X>
                  ...
                  <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="3543886268">
                    <active dataType="Bool">true</active>
                    <colorTint dataType="Struct" type="Duality.Drawing.ColorRgba">
                      <A dataType="Byte">255</A>
                      <B dataType="Byte">255</B>
                  ...
                  <item dataType="Struct" type="Player.Controller2D" id="2069117215">
                    <_x003C_HorizontalRayCount_x003E_k__BackingField dataType="Int">3</_x003C_HorizontalRayCount_x003E_k__BackingField>
                    <_x003C_SkinWidth_x003E_k__BackingField dataType="Float">0.015</_x003C_SkinWidth_x003E_k__BackingField>
                    <_x003C_VerticalRayCount_x003E_k__BackingField dataType="Int">3</_x003C_VerticalRayCount_x003E_k__BackingField>
                    <active dataType="Bool">true</active>
                  ...
                  <item dataType="Struct" type="Player.PlayerController" id="511061050">
                    <_x003C_AccelerationAirborne_x003E_k__BackingField dataType="Float">100</_x003C_AccelerationAirborne_x003E_k__BackingField>
                    <_x003C_AccelerationGrounded_x003E_k__BackingField dataType="Float">100</_x003C_AccelerationGrounded_x003E_k__BackingField>
                    <_x003C_BulletPrefab_x003E_k__BackingField dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Prefab]]">
                      <contentPath dataType="String">Data\Prefabs\Bullet.Prefab.res</contentPath>
                    ...
                    <gameobj dataType="ObjectRef">441064268</gameobj>
                    <gravity dataType="Float">444.444458</gravity>
                    <heldWeapon dataType="Struct" type="Duality.GameObject" id="799634793">
                      <active dataType="Bool">true</active>
                      <children />
                      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2283719315">
                        <_items dataType="Array" type="Duality.Component[]" id="1712119014" length="4">
                          <item dataType="Struct" type="Duality.Components.Transform" id="2596213175">
                            <active dataType="Bool">true</active>
                            <gameobj dataType="ObjectRef">799634793</gameobj>
                          </item>
                          <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="1709181187">
                            <active dataType="Bool">true</active>
                            <gameobj dataType="ObjectRef">799634793</gameobj>
                          </item>
                        </_items>
                      ...
                      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1764080376" surrogate="true">
                        <header />
                        <body>
                          <keys dataType="Array" type="System.Object[]" id="555473657">
                            <item dataType="ObjectRef">2122741390</item>
                            <item dataType="ObjectRef">3652497482</item>
                          </keys>
                          <values dataType="Array" type="System.Object[]" id="1945200256">
                            <item dataType="ObjectRef">2596213175</item>
                            <item dataType="ObjectRef">1709181187</item>
                          </values>
                        </body>
                      </compMap>
                      <compTransform dataType="ObjectRef">2596213175</compTransform>
                      <identifier dataType="Struct" type="System.Guid" surrogate="true">
                        <header>
                          <data dataType="Array" type="System.Byte[]" id="3217445115">A0P5xu17sEuEt+3rLf8XcA==</data>
                        </header>
                        <body />
                      </identifier>
                      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
                      <name dataType="String">Weapon</name>
                      <parent />
                      <prefabLink dataType="Struct" type="Duality.Resources.PrefabLink" id="1769526649">
                        <changes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Resources.PrefabLink+VarMod]]" id="1538824020">
                          <_items dataType="Array" type="Duality.Resources.PrefabLink+VarMod[]" id="1269015268" length="4">
                            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
                              <childIndex dataType="Struct" type="System.Collections.Generic.List`1[[System.Int32]]" id="2343803080">
                                <_items dataType="Array" type="System.Int32[]" id="2955721324"></_items>
                                <_size dataType="Int">0</_size>
                                <_version dataType="Int">1</_version>
                              </childIndex>
                              <componentType />
                              <prop dataType="MemberInfo" id="2245190366" value="P:Duality.GameObject:Name" />
                        ...
                        <obj dataType="ObjectRef">799634793</obj>
                    ...
                    <jumpVelocity dataType="Float">200</jumpVelocity>
                    <spriteRenderer dataType="ObjectRef">3543886268</spriteRenderer>
                    <velocity dataType="Struct" type="Duality.Vector2" />
                  </item>
                </_items>
                <_size dataType="Int">4</_size>
              ...
              <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="3839506300" surrogate="true">
                <header />
                <body>
                  <keys dataType="Array" type="System.Object[]" id="1338796664">
                    <item dataType="ObjectRef">2122741390</item>
                    <item dataType="ObjectRef">3652497482</item>
                    <item dataType="ObjectRef">533349572</item>
                    <item dataType="ObjectRef">4154674070</item>
                  </keys>
                  <values dataType="Array" type="System.Object[]" id="868297182">
                    <item dataType="ObjectRef">2558091680</item>
                    <item dataType="ObjectRef">3543886268</item>
                    <item dataType="ObjectRef">2069117215</item>
                    <item dataType="ObjectRef">511061050</item>
                  </values>
                </body>
              </compMap>
              <compTransform dataType="ObjectRef">2558091680</compTransform>
              <identifier dataType="Struct" type="System.Guid" surrogate="true">
                <header>
                  <data dataType="Array" type="System.Byte[]" id="2575275812">UPF8jIwOT0SjSKyQzVYuaQ==</data>
                </header>
                <body />
              </identifier>
              <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
            ...
            <_x003C_xLinearVelocity_x003E_k__BackingField dataType="Float">0</_x003C_xLinearVelocity_x003E_k__BackingField>
            <_x003C_yLinearVelocity_x003E_k__BackingField dataType="Float">0</_x003C_yLinearVelocity_x003E_k__BackingField>
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">42419338</gameobj>
            <lifetimeCounter dataType="Float">0</lifetimeCounter>
            <player dataType="ObjectRef">787527030</player>
            <playerController dataType="ObjectRef">1575548244</playerController>
            <rigidBody dataType="ObjectRef">3105195862</rigidBody>
            <transform dataType="ObjectRef">2402734270</transform>
          </item>
        </_items>
        <_size dataType="Int">4</_size>
        <_version dataType="Int">4</_version>
      </compList>
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2077702582" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Object[]" id="787619454">
            <item dataType="ObjectRef">2122741390</item>
            <item dataType="ObjectRef">3652497482</item>
            <item dataType="ObjectRef">2606366108</item>
            <item dataType="Type" id="435272848" value="Behavior.Bullet" />
          </keys>
          <values dataType="Array" type="System.Object[]" id="2760377994">
            <item dataType="ObjectRef">2402734270</item>
            <item dataType="ObjectRef">1684585906</item>
            <item dataType="ObjectRef">3105195862</item>
            <item dataType="ObjectRef">713102608</item>
          </values>
        </body>
      </compMap>
      <compTransform dataType="ObjectRef">2402734270</compTransform>
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="2068848398">qAjH5UDX7UykjzBxtdJpzw==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
